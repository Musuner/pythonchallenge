...
#while (i<len(str)):
	#print('a')
	#i+=1
#str='dovhsognoMINiNONINIniINLlIVNkONEyOKG'
while (i<=len(str)):
		i+=1
	#if i<=len(str):
		if str[i].isupper():
...
while (i<=len(str)):
	i+=1
	if str[i].islower():
		if str[i-1].isupper() and str[i-2].isupper() and str[i-3].isupper() and str[i-4].islower():#原来要Excatly,必须只有三个大写
			if str[i+1].isupper() and str[i+2].isupper() and str[i+3].isupper() and str[i+4].islower():
				#print(str[i-3:i+4])
				print(str[i],end='')
	continue
